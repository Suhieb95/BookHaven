...
internal class UnitOfWork(ISqlDataAccess sqlDataAccess, IDateTimeProvider dateTimeProvider, ICacheValidator cacheValidator, IMssqlDbTransaction mssqlDbTransaction)
    : IUnitOfWork
{
    ...
    public IUserService Users => _users ??= new UserService(_sqlDataAccess, _dateTimeProvider, _cacheValidator);
